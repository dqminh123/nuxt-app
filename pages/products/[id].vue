  ...
  <div class="pt-6">
      ...
      <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <li>
          <div class="flex items-center">
            <NuxtLink to="/" class="mr-2 text-sm font-medium text-gray-900">Home</NuxtLink>
        ...
        <li>
          <div class="flex items-center">
            <NuxtLink to="/products" class="mr-2 text-sm font-medium text-gray-900">{{ product.category }}</NuxtLink>
            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
              <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
            </svg>
          </div>
        ...
        <li class="text-sm">
          <NuxtLink to="/products" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{{ product.title }}</NuxtLink>
        </li>
      </ol>
    </nav>
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
        <img :src="product.image" alt="Two each of gray, white, and black shirts laying flat." class="h-50 w-50 object-cover object-center">
      </div>
      ...
      <div class="aspect-w-4 aspect-h-5 sm:overflow-hidden sm:rounded-lg lg:aspect-w-3 lg:aspect-h-4">
        <img :src="product.image" alt="Model wearing plain white basic tee." class="h-50 w-50 object-cover object-center">
      </div>
    </div>
    ...
    <NuxtLink to="/products" style="color: red;">Back</NuxtLink>
</template>
